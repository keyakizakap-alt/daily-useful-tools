...
このリポジトリには2つのプロダクトが入っています。

| アプリ | 一言 | 場所 |
|---|---|---|
| **InvoiceGuard** | 受け取った請求書が適格請求書の要件を満たしているかをAIで確認し、控除できない金額を示す | [`apps/invoice-guard/`](apps/invoice-guard/) |
| **PitchMirror** | 発表しているあなた自身を、その場で採点する鏡（以下はこのアプリの説明） | リポジトリ直下 |
